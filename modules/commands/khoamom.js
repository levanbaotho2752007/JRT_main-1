...
try {
  ...
  var path_toilet = __dirname+'/cache/khoamom.png'; 
  var id = Object.keys(event.mentions)[0] || event.senderID;
  const canvas = Canvas.createCanvas(720, 774);
	const ctx = canvas.getContext('2d');
	const background = await Canvas.loadImage('https://i.imgur.com/GyReJ4r.jpg');
	...
	ctx.drawImage(await Canvas.loadImage(avatar), 353, 70, 205, 205);
