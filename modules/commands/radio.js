module.exports.config = {
	...
	envConfig: {
		"YOUTUBE_API": "AIzaSyBDYHNvjjypPX1CGE7qcW9GSo_CAEWRw9s"
	}	
};
...
let getthumnail = (await axios.get(`${linkthumnail}`, { responseType: 'arraybuffer' })).data;
  ...
  imgthumnail.push(fs.createReadStream(__dirname + `/cache/${numb}.png`));
      ...
      var body = `Xin chào ${name}\n🎼Có ${link.length} kết quả trùng với từ khoá tìm kiếm của bạn:\n≻────── •👇🏻• ──────≺\n${msg}\n📌Hãy reply(phản hồi) chọn một trong những tìm kiếm trên\n☠Nên nhớ là clip phải dưới 25MB đấy!!!\nChúc ${name} nghe nhạc vui vẻ !!!`
