...
module.exports.run = async ({ api, event, args }) => {
 ...
 const fs = require("fs");
 axios.get('http://api.leanhtruong.net/api/image?api_key=LEANHTRUONG=5TCxa33XboLsLkpxE0nH8SzN65m8s2i5GnGrIlV4mCQ6ba38KE=APIKEY=PLANFREE&image=nude').then(res => { 
