...
"https://media2.giphy.com/media/5eFtKFqu5D34WNno9u/giphy.gif"
    ...
    var callback = () => api.sendMessage({body:`🎉Chúc mừng ${name}\n🙉Tỉ lệ có người yêu của bạn trong năm nay là: ${tle}%`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
