...
var coinscn = Math.floor(Math.random() * 1234) + 200; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 1234) + 200; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 1000) + 200; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 900) + 200; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 1547) + 200; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 1599) + 200; //random coins khi đào đá
var coinsdfk = Math.floor(Math.random() * 2156) + 200; //random coins khi đào đá
...
var rddd1 = ['solo thua', 'buscu giảng hòa', 'được chiến công đầu với', 'hạ gục']; //random công việc khi đào đá
var work7 = rddd1[Math.floor(Math.random() * rddd1.length)];
    ...
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(event.body) {
                ...
                case "7": msg = `👾Bạn đã ${work7} Faker và kiếm được ${coinsdfk}$`; await Currencies.increaseMoney(event.senderID, parseInt(coinsdfk)); break;
